...
def _rotquat_to_axis_angle(
    ...
    # Save division.
    rotation_axes = rotation_axes / (rotation_axes_norms[..., None] + tol) # Changed rotation_axes_norms[:, None] -> rotation_axes_norms[..., None]
...
############################################################################################
# The following code is copied from the pytorch3d and not from the original repo
############################################################################################
...
def rotmat_to_rotquat(matrix: torch.Tensor) -> torch.Tensor:
    """
